...
export default function PollPage() {
  ...
  return (
    <Card className="section-card" title="Would you rather?">
      ...
      <Divider />
      <Responses question={question} selected={selected} onSelect={setSelected} showResults={answered} />
      {!answered && <Button type="primary" className="mt" disabled={!selected} onClick={submit}>Submit vote</Button>}
    </Card>
  );
}
